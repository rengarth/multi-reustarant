# Сервис асинхронного взаимодействия сервисов ресторана
...
1. **Родительский проект:** `liga-restaurant`

    - Объединяет все модули в один проект.
    - Хранит конкретные версии зависимостей.
